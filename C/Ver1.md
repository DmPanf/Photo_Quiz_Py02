# ✅ Вариант 1: Консольная викторина на C++
...
# ✅ Вариант 2: Telegram-бот на C++ (через `tgbot-cpp`)

* Используется библиотека [tgbot-cpp](https://github.com/reo7sp/tgbot-cpp).
* Она работает с Bot API Telegram.
* Пример кода будет аналогичен Python-версии: вопросы + inline-кнопки.

...
* 📱 Работает в браузере (и на телефоне, и на ПК).
* 🔄 Кнопка «начать заново» для быстрой перезапуска.
* 🧠 Случайные вопросы каждый раз.
* 📊 Подсчёт процентов правильных и неправильных ответов.
